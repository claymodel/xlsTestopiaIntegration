...
import jp.elias.xls.panel.CSVPanel;
import jp.elias.xls.panel.TNSPanel;
import jp.elias.xls.panel.WelcomePanel;
import jp.elias.xls.sql.CSBIDGen;
import jp.elias.xls.sql.ExistingPIDMQuery;
import jp.elias.xls.sql.PIDMGen;
import jp.elias.xls.sql.SJUIDGen;
...
public class Main extends javax.swing.JFrame {
    ...
    private void xlsMenuItemActionPerformed(java.awt.event.ActionEvent evt) {                                            
        addXLSTab();
    ...
    public void addExistingPIDMCol( int sourceColIndex, int sourceType ) {
        setTitle( "RNC Automation Tool - Loading..." );
